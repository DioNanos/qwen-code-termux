...
If you installed the CLI globally (e.g. `npm install -g @mmmbuto/qwen-code-termux`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @mmmbuto/qwen-code-termux
```
