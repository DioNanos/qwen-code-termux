...
describe('utils upward-import flat-config integration', () => {
  // fork: cold flat-config parse under parallel workers can exceed the
  // 30s suite default on slow hosts. Timeout budget only.
  it(
    'reports value imports but allows type-only upward imports',
    { timeout: 120_000 },
    async () => {
