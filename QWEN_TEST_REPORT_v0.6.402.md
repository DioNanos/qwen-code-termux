...
| ------------------------ | ------- | ------------------------------------------------------------- |
| **1. Version & Env**     | ✅ PASS | Version 0.6.402, Node v24.12.0, aarch64, Termux paths OK |
...
- ✅ Local bundle `node dist/cli.js --version` returns `0.6.402`
...
**Fork**: @mmmbuto/qwen-code-termux v0.6.402
...
2. Push to origin
3. Create GitHub release v0.6.402
