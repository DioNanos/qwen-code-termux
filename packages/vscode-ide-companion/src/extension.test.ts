...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from ' @mmmbuto/qwen-code-core/src/ide/detect-ide.js';

vi.mock(' @mmmbuto/qwen-code-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    ' @mmmbuto/qwen-code-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
