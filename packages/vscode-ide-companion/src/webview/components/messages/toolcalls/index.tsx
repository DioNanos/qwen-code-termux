 ...
 * All UI components are now imported from  @mmmbuto/webui
 */
...
import type { BaseToolCallProps } from ' @mmmbuto/webui';
...
export type { BaseToolCallProps, ToolCallData } from ' @mmmbuto/webui';
