...
import type { ToolAskUserQuestionConfirmationDetails } from '@mmmbuto/qwen-code-termux-core';
import { ToolConfirmationOutcome } from '@mmmbuto/qwen-code-termux-core';
