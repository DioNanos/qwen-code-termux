...
import type { Config, GeminiChat } from '@mmmbuto/qwen-code-termux-core';
import { ApprovalMode, AuthType } from '@mmmbuto/qwen-code-termux-core';
import * as core from '@mmmbuto/qwen-code-termux-core';
import type {
  AgentSideConnection,
  PromptRequest,
